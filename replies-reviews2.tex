...
``As shown in Section 2.3.1, reduplication can also express
 ...
 like just \obj{le} illustrated here. 
...
%%%%%%%%%%%%%%%%%%%
\noindent
\textbf{Answer:} We do not claim that the syntactic analyses of reduplication consider it as repetition. We added a footnote to clarify this point.
...
%%%%%%%%%%%%%%%%%%%
\noindent
\textbf{Answer:} We cannot exclude these verbs syntactically but can semantically.
\todo[inline]{YL to do: elaborate}
...
\z
    ...
    %%%%%%%%%%%%%%%%%%%
    \noindent
    \textbf{Answer:} The rationale of the test in (43) to insert an adverb in-between the reduplication is that a verb can be modified by an adverb but not an adjective as in (42).
    In Mandarin Chinese, adverb modification is only permitted pre-verbally and not post-verbally, as illustrated in the example below (\ref{ex:adv}).
    \ea\label{ex:adv}
    ...
    \z\z
    Therefore, the general explanation for the ungrammaticality of \obj{kai1} \obj{tou1tou1de} \obj{men2} is that the adverb cannot occur after the verb.
    This is not a problem in (43) as the adverb can, in principle, be interpreted as modifying the second verb.
    \todo[inline]{YL: citation}
