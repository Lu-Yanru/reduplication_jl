...
\textbf{Answer: } We replaced the example by adjectival inflection in German.
...
\textbf{Answer: } The \obj{ji4-gei3} example was suggested by another reviewer, as \citet[1282]{Her2006} claims that the V-\obj{gei3} sequence forms a single lexical item. 
...
They also completely rejected A-\obj{yi}-A being separated by complex noun phrases, such as *\obj{deng3} \obj{na4} \obj{ren2} \obj{yi} \obj{deng3} `wait for that person a bit',  *\obj{kan4} \obj{ta1de} \obj{lian3} \obj{yi} \obj{kan4} `take a look at his face'.
In contrast, the verbal classifier counterparts are totally acceptable: \obj{deng3} \obj{na4} \obj{ren2} \obj{yi} \obj{xia4} `wait for that person a bit',  \obj{kan4} \obj{ta1de} \obj{lian3} \obj{yi} \obj{xia4} `take a look his face'.
...
Considering that reduplication developed from verbs being borrowed as verbal classifiers (\citealt{Zhang2000}, see also Appendix B)
