...
%%%%%%%%%%%%%%%%
Answer: % need to think about this more
...
we do agree that they are different grammatical processes and thus requires separate analyses.
Also note that there are numerous scholars that do consider the forms above as morphological processes (cite xxxxxxxxxxxx).
\citet[83--84]{Xie2020} also suggests that AABB is much less productive than ABAB.
...
The current analysis has a broad scope in that it explains all forms of productively formed verbal reduplication, which previous analyses were not able to do.
%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%
%% YL
