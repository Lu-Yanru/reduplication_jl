...
The reason for \obj{le} `\textsc{pfv}' being the only aspect marker compatible with reduplication is explained in Section 2.3.3 concerning the semantics of the reduplication and the aspect markers.
...
\type{perfective-reduplication-lr} in (51) (59 in the current version of the paper), which says that the PHON value of the daughter \ibox{1} appears
