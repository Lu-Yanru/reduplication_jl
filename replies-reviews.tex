...
we women {} only can give.birth.to-give.birth.to children\\\jambox{(BCC)}
...
Context: \objex{Wang2} \objex{Sheng4di2} is the actor of \objex{Gu4} \objex{Miao3} in a TV series. \objex{Wang2} \objex{An1yu3} is another actor in the series.\\
\\
...
%%%%%%%%%%%%%%%%%%%%%%
Answer: reformulate as ``behaves more similar to a word''.
