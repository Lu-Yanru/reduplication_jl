...
and viewpoint aspect, i.e. ``the aspectual information reflected bz the temporal perspective the speaker takes in presenting a situation'' \citep[21]{XiaoMcEnery2004}.
...
The verb classes are determined with verbs in a neutral context, 
...
(see \citealt[52]{XiaoMcEnery} for the detailed operationalization for Mandarin Chinese).
...
as opposed to stage-level states (SLSs) which can have both stative and dynamic interpretations.
...
As we discussed in Sec. 2.3.1 in the previous version of the paper, the semantics of the reduplication has the properties of tansitoriness, holisticity and dynamicity.
...
These verbs are stative in a neutral context can can thus be classified as stative verbs.
The point of our argument is that reduplication can be applied to verbs of all verb classes.
The dynamicity also explains the general tendency for reduplication to appear in imperative contexts.

Finally, as noted briefly in Sec. 2.2 in the previous version of the paper,
the reduplication is incompatible with an expression that quantifies the duration or the extent of the event,
 because the reduplication already contains a (abstract) quantity meaning, namely a short duration or a small extent.
