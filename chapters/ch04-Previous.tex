...
because if \obj{san1} \obj{xia3} `three times' is replaced with \objex{yi2} \obj{xia4} `once' in (\ref{ex:clf-idiom}), he/she can still get the idiomatic interpretation.
