...
\ea\label{ex:incomplete}
 \gll \objex{Xiao3li3} \objex{chi1}-zhe/le/\objex{wan42} fan *(le).\\
...
\z
He thus propose three aspect positions under TP. \obj{zai4} `\textsc{prog}' and \obj{guo} `\textsc{exp}' reside under Asp$_1$, 
