...
He observed that  \obj{zhe} `\textsc{prog}', \obj{le} `\textsc{pfv}' and \obj{wan2} `\textsc{compl}' necessarily occur with additional information about the event denoted by the sentence (\ref{ex:incomplete}), 
