...
\caption{Analysis of \emph{chang2-le-chang2} taste-\textsc{pfv}-taste `taste the soup a little bit'}\label{fig-he-tasted-the-soup-a-little-bit}
\end{figure}

The figure shows how the lexical item for \emph{chang2} `to taste' is inserted as a daughter into
the \type{a-le-a-lr} lexical rule. The arguments of \emph{chang2} `to taste' are represented within the \spr and
the \compsl (see \citet{GSag2000a-u} for English) and the respective argument NPs are linked to the
...
is the concatentation of \emph{chang2}, \emph{le} and \emph{chang2}, as specified in the constraint
on \type{a-le-a-lr} in (\ref{avm:a-le-a-lr}). The resulting unit \emph{chang2-le-chang2} then
combines with its object forming a VP. This VP is combined with the subject resulting in a complete
verbal projection, a sentence. \emph{chang-le-chang} behaves in the same way as the simple \emph{chang2}.
...
\footnotetext{\textit{Yuanqu xuan: Luzhailang [Selected Yuanqu: Luzhailang]}, as cited in \citet[15]{Zhang2000}}
...
\footnotetext{\textit{Yuan Ming juan: Piaotongshi [Yuan and Ming volume: Piaotongshi]}, 308, as cited in \citet[15]{Zhang2000}}
...
\footnotetext{Rou, Shi. 1975. \textit{Roushi xiaoshuo xuanji [Selected novels of Roushi]}, 31. Beijing: People's Literature Publishing House.}
...
\footnotetext{Li, Jieren. 1962. \textit{Da bo [Great wave]}, 3rd band, 171. Beijing: The Writers Publishing House.}
