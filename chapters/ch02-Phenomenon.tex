...
\label{ex:syn-quan}
		\ea[]{\gll \objex{ta1} \objex{yi4} \objex{tian1} \objex{pao3} \objex{shi2} \objex{li3}.\\
...
We will then investigate the interaction of the reduplication with verb classes (\sectref{sec:Aktionsarten}) and aspect markers (\sectref{sec:aspM}).
