...
As mentioned above, whether aspect markers are considered to be morphological or syntactic elements depends on the theoretical framework (and possibly the target language).\footnote{For example, \citet[Sec. 3.3.1]{Huangetal2009} and \citet[246]{MuellerLipenkova2013} considered the postverbal aspect markers (\textit{-le}, \textit{-zhe} and \textit{-guo}) in Mandarin Chinese to be morphological elements. E.g. \citet{Travis2000, Arcodiaetal2014, BascianoMelloni2017} considered all aspect information to be syntactically encoded.} 
