...
\ea\label{ex:forms-mono} for monosyllabic verbs: \textit{shuo} `say'
	\ea \gll shuo-shuo\\ 
		say-say\\ \hfill AA
		\ex \gll shuo-yi-shuo\\
		say-one-say\\ \hfill A-\textit{yi}-A
		\ex \gll shuo-le-shuo\\
		say-\textsc{pfv}-say\\ \hfill A-\textit{le}-A
		\ex \gll shuo-le-yi-shuo\\
		say-\textsc{pfv}-one-say\\ \hfill A-\textit{le}-\textit{yi}-A
		\ex \gll shuo-shuo-kan\\
		say-say-look\\ \hfill AA-\textit{kan}
		\ex \gll shuo-kan-kan\\
		 say-look-look\\ \hfill A-\textit{kan}-\textit{kan}
		\z

\ex\label{ex:forms-di} for disyllabic verbs: \textit{lai-wang} come-go `come and go/communicate'
		\ea \gll lai-wang-lai-wang\\
		come-go-come-go\\ \hfill ABAB
		\ex \gll lai-wang-le-lai-wang\\
		come-go-\textsc{pfv}-come-go\\ \hfill AB-\textit{le}-AB
		\ex \gll lai-lai-wang-wang\\
		come-come-go-go\\ \hfill AABB
		\z

\ex\label{ex:forms-vo} for V-O compounds: \textit{shuo-huang} tell-lie `lie'
		\ea \gll shuo-shuo-huang\\
		tell-tell-lie\\ \hfill AAB
		\ex \gll shuo-yi-shuo-huang\\
		tell-one-tell-lie\\ \hfill A-\textit{yi}-AB
		\ex \gll shuo-le-shuo-huang\\
		tell-\textsc{pfv}-tell-lie\\ \hfill A-\textit{le}-AB
		\z
\z
...
\ex Under negation:
		...
		why I not look-look he other aspect \textsc{de} progress and comprehensive \textsc{de} development\\ \hfill {({CCL})}
...
\ex In \textit{ba}-construction:
		...
		purchase-buy before really should \textsc{ba} situation touch-touch clearly\\ \hfill {({CCL})}
...
\ex With modal verb:
		...
		there.be two \textsc{clf} book you-\textsc{pl} can read-read\\ \hfill {({CCL})}
...
\ex\label{ex:syn-svc} In Serial Verb Construction (SVC):
		...
		she go.to memorial-hall east-side \textsc{de} one place film.developing-department ask master help look-look where come.out-\textsc{pfv} problem\\ \hfill {({CCL})}
...
\ex With an expression of quantity: \label{ex:syn-quan}
		...
		he one day run ten mile\\ \hfill {\citep[83]{Li1998}}
...
The reduplication has a \textit{delimitativeness} meaning \citep[e.g.][]{Chao1968, Chen2001, Dai1997, Li1996, LiThompson1981, Tsao2001, XiaoMcEnery2004, Xing2000, Yang2003, Zhu1998}. 
...
\ea
  \ea\label{ex:le-dyn-look}
    ...
    Wu Xumang look-\textsc{pfv} commit-crime when leave \textsc{de} footprint\\ \hfill {\citep[158]{XiaoMcEnery2004}}
  ...
  \ex\label{ex:redup-dyn-look}
    ...
    Wu Xumang look-\textsc{pfv}-look commit-crime when leave \textsc{de} footprint\\ \hfill {\citep[158]{XiaoMcEnery2004}}
...
but now current everybody also can.only feel.wronged-feel.wronged \textsc{ptc}\\ \hfill {({CCL})}
...
she-\textsc{pl} can do \textsc{de} just be be.willful-be.willful-temperament play a.little small temper drop-drop tear what \textsc{de}\\ \hfill {({CCL})}
...
he win-\textsc{pfv}-win that \textsc{clf} competition\\ \hfill {\citep[155]{XiaoMcEnery2004}}
...
I really want be.sick-one-be.sick rest it \textsc{clf} ten day half month\\ \hfill {\citep[54]{Chen2001}}
...
let she give.birth.to-give.birth.to child then know \textsc{cop} mother \textsc{de} sweet-bitter \textsc{ptc}\\ \hfill {\citep[112]{Chen2005}}
...
\ea
  \ea\label{ex:cry}
    ...
    for.this Deng Lijun sadly \textsc{de} cry-\textsc{pfv} three day\\ \hfill {\citep[129]{XiaoMcEnery2004}}
    \glt `For this reason, Deng Lijun cried sadly for three days.'
  \ex\label{ex:know}
    \gll Ta zhidao-le zhe shi de nei-qing.\\
    he know-\textsc{pfv} this matter \textsc{de} inside-information\\ \hfill {\citep[130]{XiaoMcEnery2004}}
...
\ea
  \ea\label{ex:guo-dyn}
    ...
    he serve.as-\textsc{exp} soldier\\ \hfill {\citep[149]{XiaoMcEnery2004}}
    \glt `He once served as a soldier.'
  \ex\label{ex:le-dyn}
    \gll ta dang-le bing.\\
    he serve.as-\textsc{pfv} soldier\\ \hfill {\citep[149]{XiaoMcEnery2004}}
...
\ea\label{ex:le-insertionAA}
  ...
  Yao Ming look-\textsc{pfv}-look he \textsc{de} translator Ke Lin\\ \hfill {({CCL})}
  \glt `Yao Ming looked at his translator Ke Lin a little bit...'
  \z
\z
...
\ea\label{ex:le-insertionABAB}
 ...
 \glt `He considered a little bit, and told Jiangqing...'
  ...
  he consider-\textsc{pfv}-consider to Jiangqing say\\ \hfill {({CCL})}
  \glt `He considered a little bit, and told Jiangqing...'
  \z
\z
...
\ea\label{ex:le-insertionAABB}
  ...
  shake-shake-sway-sway then pull out \textsc{ptc}\\  \hfill {\citep[85]{Xie2020}}
  ...
  shake-shake-\textsc{pfv}-sway-sway then pull out \textsc{ptc}\\ \hfill {\citep[85]{Xie2020}}}
  \z
\z
...
\ea\label{ex:AABBadv}
  ...
  electric-car shake-sway-shake-sway drive away...\\ \hfill {\citep[86]{Xie2020}}}
  
  \ex[]{\gll dian-che \textit{yao}-\textit{yao}-\textit{huang}-\textit{huang} kai zou...\\
  electric-car shake-shake-sway-sway drive away...\\ \hfill {\citep[86]{Xie2020}}
...
\ea\label{ex:AABBadj}
  ...
  sit on shake-sway-shake-sway \textsc{de} car on\\ \hfill {\citep[86]{Xie2020}}}
  
  \ex[]{\gll ...zuo zai  \textit{yao}-\textit{yao}-\textit{huang}-\textit{huang} de che shang\\
  sit on shake-shake-sway-sway \textsc{de} car on\\ \hfill {\citep[86]{Xie2020}}
...
\ea\label{ex:trans}
  ...
  knock-beat liver-channel \textsc{cop} relieve liver-\textit{qi} \textsc{de} good method\\ \hfill {\citep[88]{Xie2020}}
  ...
  knock-beat-knock-beat liver-channel \textsc{cop} relieve liver-\textit{qi} \textsc{de} good method\\ \hfill {\citep[88]{Xie2020}}
  ...
  knock-knock-beat-beat liver-channel \textsc{cop} relieve liver-\textit{qi} \textsc{de} good method\\ \hfill {\citep[88]{Xie2020}}}
...
\ea\label{ex:co-phrase}
  ...
  old \textsc{de} book and new \textsc{de} book\\ \hfill {\citep[137]{Duanmu1998}}
  \glt `old books and new books'
  
  \ex \gll [jiu de gen xin de] shu\\
  old \textsc{de} and new \textsc{de} book\\ \hfill {\citep[137]{Duanmu1998}}
...
\ea\label{ex:co-word}
  ...
  fire-car and gas-car\\ \hfill {\citep[137]{Duanmu1998}}
  \glt `train and automobile'}
  
  \ex[*]{
  \gll [huo gen qi] che\\
  fire and gas car\\ \hfill {\citep[137]{Duanmu1998}}}
  \z
\z
...
\ea
  ...
  \gll wujian gong-xiu mo dian bohe-gao huo \textit{jiao}-\textit{jiao} kouxiangtang.\\
    midday work-break apply a.little mint-cream or chew-chew chewing.gum\\ \hfill {({CCL})}
   ...
   Song Ailing look-\textsc{pfv}-look bath.tub again walk-\textsc{pfv} out\\  \hfill {({CCL})}
