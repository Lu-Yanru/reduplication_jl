...
In Mandarin Chinese, verbs can be reduplicated to express a delimitative aspectual meaning \parencites[e.g.][204--205]{Chao1968}[232]{LiThompson1981}[14]{Li1996}[70]{Dai1997}[382--383]{Zhu1998}[420--421]{Xing2000}[48]{Chen2001}[288]{Tsao2001}[11--12]{Yang2003}[Sec.\,4.3]{XiaoMcEnery2004}. 
...
offers a novel analysis of this phenomenon in the theoretical framework of Head-driven Phrase Structure Grammar (HPSG; \citealt{PollardSag1994, Sag1997, HPSGHandbook-2})  
...
\glt `She \ldots\, asked the master to help have a look at where the problem was.'
\ex 
...
\glt `She \ldots\, asked the master to help have a quick look at where the problem was.'
\zl
...
\ea[]{
\gll {[[\objex{tong2xue2-men}} \objex{tao3lun4} \objex{de]} \objex{zhe4} \objex{ge4} \objex{wen4ti2]} \objex{fei1chang2} \objex{zhong4yao4}.\\
      \hphantom{[[}student-\textsc{pl} discuss \textsc{de} this \textsc{clf} question very important\\
\glt `The question that the students discussed is very important.'}

\ex[*]{ 
\gll {[[\objex{tong2xue2-men}} \obj{tao3lun4-tao3lun4} \objex{de]} \objex{zhe4} \objex{ge4} \objex{wen4ti2]} \objex{fei1chang2} \objex{zhong4yao4}.\\
      \hphantom{[[}student-\textsc{pl} discuss-discuss \textsc{de} this \textsc{clf} question very important\\}
%\glt `The question that the students discussed is very important.'}

\ex[]{
\gll {[[\objex{tong2xue2-men}} \objex{xu1yao4} (\objex{zai4}) \obj{tao3lun4-tao3lun4} \objex{de]} \objex{zhe4} \objex{ge4} \objex{wen4ti2]} \objex{fei1chang2} \objex{zhong4yao4}.\\
      \hphantom{[[}student-\textsc{pl} need again discuss-discuss \textsc{de} this \textsc{clf} question very important\\
...
\footnotetext{We found this sentence in the BCC corpus, but one reviewer finds it unnatural.
    ...
    All found the sentence weird at first glance, but considered that the acceptability can be greatly improved 
...
The reduplication has a \textit{delimitativeness} meaning \parencites[e.g.][204--205]{Chao1968}[232]{LiThompson1981}[14]{Li1996}[70]{Dai1997}[382--383]{Zhu1998}[420--421]{Xing2000}[48]{Chen2001}[288]{Tsao2001}[11--12]{Yang2003}[Sec.\,4.3]{XiaoMcEnery2004}. 
To be specific, the reduplication of [$+$durative] verbs reduces the duration of the events,
and the reduplication of [$-$durative] verbs reduces the iteration frequency of the events \parencites[14]{Li1996}[149--150]{XiaoMcEnery2004}.
Besides delimitativeness, \citet[204]{Chao1968}, \citet[276]{Fan1964}, \textcites[356]{Smith1991}[199--120]{Smith1994}, \citet[14]{Li1996}, and \citet[290--291]{Tsao2001} suggest that the reduplication signifies \textit{tentativeness}, which can be used
...
The semantics of the reduplication has the properties of transitoriness,  holisticity  and dynamicity \parencites[70--79]{Dai1997}[155--159]{XiaoMcEnery2004}.
...
\gll \objex{wo2men} \objex{nv3ren2} [\ldots] \objex{zhi3} \objex{neng2} \obj{sheng1-sheng1}
\objex{hai2zi} [\ldots] \\
...
\glt `Let her have a try at giving birth to a child and then she will know the bittersweetness of being a mother.'
\z
\z
%\end{sloppypar}
...
The reduplication is incompatible with an expression that quantifies the duration or the extent of the event expressed in the sentence (\ref{ex:syn-quan}) \parencites[83--84]{Li1998}[114--115]{Chen2005}.
This is  because the reduplication already contains a quantity meaning \parencites[84]{Li1998}[114--115]{Chen2005}, namely a short duration or a small extent,
which cannot be measured on a concrete scale \parencites[155]{XiaoMcEnery2004}[333]{SuiHu2016}.
...
Further, if \obj{le} is considered to be a morphological element \parencites[e.g.][101--102]{Huangetal2009}[246]{MuellerLipenkova2013}, the insertion of \obj{le} does not have to be viewed as a syntactic
process either.
...
\gll \objex{xu3duo1} \objex{tong2zhi4} \ldots\, \objex{zi4dong4de} \objex{dui4} \objex{bing4yuan2} \objex{guan1-le-}\objex{xin1}.\\
...
\noindent
In any case, since reduplication is not compounding (\cites[149--150]{Sui2018}{GaoEtAl2021} provide psycholinguistic evidence),
...
Expansion is possible for a verbal classifier phrase (\ref{ex:inVCP}), as the object can occur after or in between.
...
\glt `open the door three times'
\z\z
For reduplication, expansion is also not possible (\ref{ex:inVV}), as the object cannot be inserted between the two verbs.
\ea\label{ex:inVV}
...
\z\z
The above two tests indicate a lexical analysis for reduplication.
...
than syntactic reduplication (below as \textit{repetition}; \cites[31]{Gil2005}[1--2]{Forza2016}).\footnote{
...
In sum, we maintain that verbal reduplication in Mandarin Chinese is better analyzed as a morphological phenomenon.
...
However, there are several arguments suggesting that the reduplication cannot be analyzed the same way as a verbal classifier phrase. First, the verb and the verbal classifier can be separated (\ref{ex:clf-sep}), while the reduplication cannot (\ref{ex:redup-sep}) \citep[269]{Paris2013}.\footnote{
  \label{fn:vclpron}
One reviewer notes that the objects that can be placed in between the verbal classifier phrase are usually limited to pronouns and proper nouns.
...
In this case, it is easy to interpret \obj{yi2} \obj{xia4} and \obj{liang3} \obj{xia4} not as referring to the actual number of actions taking place,
but as duration adverbials as a whole,
thus distinguishing hem from ``actual'' verbal classifier phrases with other numerals.
}
...
\noindent
Based on these observations, it seems inappropriate to view reduplication as involving a kind of verbal classifier phrase.
...
Dynamic and volitional verbs have the features [init proc] and are therefore located under \textit{init} and \textit{proc}  \parencites[24]{Arcodiaetal2014}[147]{BascianoMelloni2017}.  
Achievement verbs possess the feature [res] and reside under \textit{res}  \parencites[24]{Arcodiaetal2014}[147]{BascianoMelloni2017}. 
...
We worked out the analysis for reduplication based on \citet{Tsai2008},
...
MRS is an instance of underspecified semantics as is currently used in theoretical and
...
label of the delimitative relation, hence \type{delimitative-rel} is treated as an intersective modifier.  Further
...
The label of the \type{delimitative-rel} and the input verb are identified (\type{delimitative-rel}
is an intersective modifier) and this shared label is embedded under the \type{perfective-rel}.
...
\z
So the delimitative relation is treated as an intersective modifier to the main relation of the verb, 
...
They inherit the semantic change to the input from \type{perfective\hyp{}reduplication\hyp{}lr}, but specify the \textsc{phon} value differently.
...
The possible historical and phonological reasons for \emph{yi} and \emph{le} being the phonological elements left
in the reduplication structure are discussed in Appendix~\ref{app:hist}.
...
[\avm{ [phon & \1 \phonliste{ \obj{chang2} }\\
       synsem\textbar loc & [cat  & [ head  & verb\\
                                      spr   & < NP$_{\6}$ >\\
                                      comps & < NP$_{\7}$ > ]\\
                             cont & [ ltop & \4\\
...
the \compsl (see \citealt[23]{GSag2000a-u} for English) and the respective argument NPs are linked to the
...
Although these forms are considered unacceptable by some authors \parencites[30]{LiThompson1981}[275--276]{Hong1999}[160]{BascianoMelloni2017}[239]{YangWei2017}, 
...
Indeed, a few examples of AB\hyp{}\emph{yi}\hyp{}AB and AB\hyp{}\emph{le}\hyp{}\emph{yi}\hyp{}AB in Old Mandarin %(12th to 20th centuries)
...
\gll \objex{ta1} \obj{wei1xiao4-le-yi-wei1xiao4}, \objex{you4} \obj{ming2xiang3}-\obj{le-yi}-\obj{ming2xiang3}.\footnotemark\\
...
many scattered-\textsc{dur} \textsc{de} boat in \textsc{de} light also flicker \textsc{de} change-\textsc{pfv}-one-change position\\ \jambox{(CCL)}
...
The reason for this degradedness is probably phonological, since AB-\textit{yi}-AB and AB-\textit{le}-\textit{yi}-AB contain too many syllables \parencites[274]{Fan1964}[15]{Zhang2000}[239]{YangWei2017}[143]{Sui2018}, but we argue that it is not an issue of grammaticality.
...
One reviewer suggests that given that AB-\textit{yi}-AB and AB-\textit{le}-\textit{yi}-AB were
possible in previous stages of the language
\parencites[see][15]{Zhang2000}[160--161]{BascianoMelloni2017}, these rare occurrences can be seen as relics of this usage.
}
...
Specifically, AAB, A-\textit{yi}-AB and A-\textit{le}-AB can be considered as the compound of a reduplicated monosyllabic verb (A) and a noun (B).\footnote{
    \citet[64--65]{Huang1984} and \textcites[Sec.\,2]{Her1996}[Sec.\,3.1]{Her2010} argue that some of these V-O combinations are compounds, some are phrases, and some have dual status (both compounds and phrases).
...
but about issue not issue-\textsc{exp} conformity-certificate already say not clealy \textsc{ptc} need check-one-check-look\\ \jambox{(CCL)}
...
We can see the similarities between \obj{li} in A-\obj{li}-AB and \obj{yi} in A-\obj{yi}-A: they are both relatively unmarked and occupy an unstressed position.
